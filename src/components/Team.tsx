...
const Team = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Expert in climate justice and environmental policy with over 15 years of experience."
    },
    {
    ...
    {
      name: "Youth Empowerment Coordinator",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Meet the passionate individuals driving change through advocacy, education, and community engagement.
          </p>
        </div>
          ...
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-hatua-blue font-semibold mb-3">{member.role}</p>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-hatua-yellow/10 to-hatua-green/10 rounded-2xl p-8 max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 text-lg mb-6">
              ...
              empowered communities and sustainable development.
            </p>
            <button className="bg-hatua-green hover:bg-hatua-green/90 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
